/*| AZURY-DJS • INDEX-FILE • DJS |*/
/*| CODED BY • Azury Devs • 2022 |*/
...
module.exports = {
	...
	randomCase: function(string) {
		let result = '';
		if (!string) throw new TypeError('Azury Error: A string was not specified.');
		if (typeof string !== 'string') {
			throw new TypeError('Azury Error: Provided string is Invalid.');
		}
	...
	randomizeNumber: function(start, end) {
		if (!start) throw new TypeError('Azury Error: A number was not specified.');
		if (!end) throw new TypeError('Azury Error: A number was not specified.');
		if (typeof start !== 'number' && typeof end !== 'number') {
			throw new TypeError('Azury Error: Provided number data is Invalid');
		}
		const res = Math.floor(Math.random() * (end - start + 1) + start);
		return res;
	},
	randomizeString: function(array) {
		if (!array) throw new TypeError('Azury Error: A array was not specified.');
		if (typeof array !== 'object') {
			throw new TypeError('Azury Error: The provided array is invalid.');
		}
